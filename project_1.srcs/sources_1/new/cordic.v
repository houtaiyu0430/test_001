...
`define rot0  32'd2949120       //45業*2^16
`define rot1  32'd1740992       //26.5651業*2^16
`define rot2  32'd919872        //14.0362業*2^16
`define rot3  32'd466944        //7.1250業*2^16
`define rot4  32'd234368        //3.5763業*2^16
`define rot5  32'd117312        //1.7899業*2^16
`define rot6  32'd58688         //0.8952業*2^16
`define rot7  32'd29312         //0.4476業*2^16
`define rot8  32'd14656         //0.2238業*2^16
`define rot9  32'd7360          //0.1119業*2^16
`define rot10 32'd3648          //0.0560業*2^16
`define rot11 32'd1856          //0.0280業*2^16
`define rot12 32'd896           //0.0140業*2^16
`define rot13 32'd448           //0.0070業*2^16
`define rot14 32'd256           //0.0035業*2^16
`define rot15 32'd128           //0.0018業*2^16
